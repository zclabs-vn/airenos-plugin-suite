...
namespace AirenoOS.BricsCAD.Plugin.Schema
{
    ...
    internal class ExtractionPayload
    {
        ...
        public string SourceSoftware { get; set; } = "bricscad";
        ...
        public List<LayerSignal> LayerTable { get; set; } = new();

        [JsonPropertyName("annotations")]
        public List<AnnotationSignal> Annotations { get; set; } = new();

        [JsonPropertyName("dimensions")]
        public List<DimensionSignal> Dimensions { get; set; } = new();

        [JsonPropertyName("hatches")]
        public List<HatchSignal> Hatches { get; set; } = new();
