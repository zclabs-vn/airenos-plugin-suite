<#
  Post-build patch for AirenoOS.BricsCAD.Plugin.msi
  ...
  Effect at install time:
    - VersionSelectDlg checkbox CbV25 is DISABLED if BRICSCAD_V25_FOUND is empty
    - Same for CbV26
  So a user without a given BricsCAD version sees the checkbox greyed out and cannot tick it.
#>
...
$rows = @(
  @{Ctl='CbV25'; Act='Disable'; Cond='NOT BRICSCAD_V25_FOUND'},
  @{Ctl='CbV25'; Act='Enable';  Cond='BRICSCAD_V25_FOUND'},
  @{Ctl='CbV26'; Act='Disable'; Cond='NOT BRICSCAD_V26_FOUND'},
  @{Ctl='CbV26'; Act='Enable';  Cond='BRICSCAD_V26_FOUND'}
)
